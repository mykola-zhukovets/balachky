...
def _scan_one_dialog(name, factory, lang, results, app, qt):
    """Збудувати, показати, просканувати й закрити ОДИН діалог. Sol-фікс 3:
...
def _match_key(v) -> tuple:
    ...
    масштабі). Sol-фікс 5: widget-шлях (_widget_path: ланцюг класів+objectName) у
...
def selfcheck(app, qt) -> int:
    ...
    # Sol-фікс 3: зламана фабрика діалогу МУСИТЬ ловитись як dialog_broken (валить
