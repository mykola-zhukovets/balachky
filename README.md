...
<p align="center">
  <img src="https://img.shields.io/badge/реліз-v1.2.4.1--beta-1f6feb" alt="Реліз v1.2.4.1-beta">
...
<p align="center">
  <a href="https://github.com/mykola-zhukovets/balachky/releases/download/v1.2.4.1-beta/BalachkySetup-1.2.4.1-beta-3C5F6144.exe"><img src="https://img.shields.io/badge/Завантажити_бета--реліз-2ea043?style=for-the-badge" alt="Завантажити бета-реліз v1.2.4.1 для Windows" height="44"></a>
  <br>
...
- У білді 1.2.4.1 рушія озвучення ще немає: він потребує окремої збірки й надійде одним із наступних оновлень — так само офлайн. Ми радше чесно покажемо кнопку, що “ще їде”, ніж вдамо, ніби все готово.
...
1. Завантажте `BalachkySetup-1.2.4.1-beta-3C5F6144.exe` зі сторінки [v1.2.4.1-beta](https://github.com/mykola-zhukovets/balachky/releases/tag/v1.2.4.1-beta). Префікс контрольної суми — одразу в назві файла, щоб збірку було легко впізнати.
...
Перевірити цей файл на VirusTotal за його SHA-256: [сторінка файла](https://www.virustotal.com/gui/file/3c5f61447c22596cfed5b5acd8c32d88a4b91be1768b0defe340233437186145/detection). Якщо звіту ще немає, файл можна надіслати на перевірку самостійно. Результат сканування є додатковою перевіркою, а не заміною звіряння SHA-256.
