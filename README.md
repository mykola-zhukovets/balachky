...
<p align="center">
  <img src="https://img.shields.io/badge/release-v1.2.4.1--beta-1f6feb" alt="Випуск v1.2.4.1-beta">
...
<p align="center">
  <a href="https://github.com/mykola-zhukovets/balachky/releases/download/v1.2.4.1-beta/BalachkySetup-1.2.4.1-beta-3C5F6144.exe"><img src="https://img.shields.io/badge/Завантажити_для_Windows_(.exe)-2ea043?style=for-the-badge" alt="Завантажити Балачки v1.2.4.1 beta для Windows" height="44"></a>
  <br>
  <a href="https://github.com/mykola-zhukovets/balachky/releases/tag/v1.2.4.1-beta">Відомості про випуск</a>
  <br>
...
**100 мов розпізнавання у v1.2.4.1-beta · Автоматичне визначення мови · Інтерфейс українською та англійською**
...
Записуйте весь монітор або одне вікно в окремому режимі. У v1.2.4.1-beta пункт “Ділянка” ще записує перший монітор, а не довільно обраний фрагмент.
...
- **Озвучення тексту:** інтерфейс є, але рушій озвучення не входить до публічного інсталятора v1.2.4.1-beta.
...
| Перевірка з’єднання в майстрі налаштування | v1.2.4.1-beta створює TCP-з’єднання з `1.1.1.1:53`, коли відкривається майстер налаштування; перевірка не надсилає голосу чи розшифровок |
...
Завантажте `BalachkySetup-1.2.4.1-beta-3C5F6144.exe` з [офіційної сторінки випуску v1.2.4.1-beta](https://github.com/mykola-zhukovets/balachky/releases/tag/v1.2.4.1-beta) і запустіть інсталятор. Для завантаження моделі потрібен інтернет, якщо Ви не імпортуєте файли з офлайн-пакета.
...
У записі перевірки випуску від 26 липня 2026 року для цього точного файла зазначено [0 виявлень серед 65 рушіїв VirusTotal](https://www.virustotal.com/gui/file/3c5f61447c22596cfed5b5acd8c32d88a4b91be1768b0defe340233437186145/detection). Це інформаційний результат, а не гарантія безпеки.
