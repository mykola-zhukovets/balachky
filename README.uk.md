...
> Це публічна бета-версія. Склад функцій, окремі елементи інтерфейсу та майбутні умови для модулів поза базовим диктуванням можуть змінюватися. Базове локальне диктування залишається безкоштовним.
...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>Диктування — безкоштовне; «Нарада» — на час бети</h3>
...
- **Переслухати й виправити себе.** Кожне диктування в Історії можна прослухати власним голосом і виправити текст. Виправлення зберігаються окремо, а оригінальний запис залишається незмінним.
