...
Балачки працюють у 64-розрядній Windows 10 або 11. Інсталятор займає близько 162 МБ. Для моделей розпізнавання й додаткових компонентів потрібне окреме місце на диску; загальний обсяг залежить від Вашого вибору.
...
Перевірити цей файл на VirusTotal за його SHA-256: [сторінка файла](https://www.virustotal.com/gui/file/20862c0159ed6806a234085c27b3bc108a601161c63c730767f8d644fbbc43b6/detection). Якщо звіту ще немає, файл можна надіслати на перевірку самостійно. Результат сканування є додатковою перевіркою, а не заміною звіряння SHA-256.
