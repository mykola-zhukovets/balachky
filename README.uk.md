...
<p align="center">
  <img src="https://img.shields.io/badge/release-v1.2.4.4--beta-1f6feb" alt="Випуск v1.2.4.4-beta">
...
<p align="center">
  <a href="https://github.com/mykola-zhukovets/balachky/releases/download/v1.2.4.4-beta/BalachkySetup-1.2.4.4-beta-42203EA0.exe"><img src="https://img.shields.io/badge/Завантажити_для_Windows_(.exe)-2ea043?style=for-the-badge" alt="Завантажити Балачки v1.2.4.4 beta для Windows" height="44"></a>
  <br>
  <a href="https://github.com/mykola-zhukovets/balachky/releases/tag/v1.2.4.4-beta">Відомості про випуск</a>
  <br>
...
**100 мов розпізнавання у v1.2.4.4-beta · Автоматичне визначення мови · Інтерфейс українською та англійською**
...
Записуйте весь монітор або одне вікно в окремому режимі. У v1.2.4.4-beta пункт “Ділянка” ще записує перший монітор, а не довільно обраний фрагмент.
...
- **Озвучення тексту:** інтерфейс є, але рушій озвучення не входить до публічного інсталятора v1.2.4.4-beta.
...
| Перевірка з’єднання в майстрі налаштування | v1.2.4.4-beta створює TCP-з’єднання з `1.1.1.1:53`, коли відкривається майстер налаштування; перевірка не надсилає голосу чи розшифровок |
...
Балачки працюють у 64-розрядній Windows 10 або 11. Інсталятор займає 158,7 МіБ (166,4 МБ; 166 392 022 байти). Для моделей розпізнавання й додаткових компонентів потрібне окреме місце на диску; загальний обсяг залежить від Вашого вибору.

Завантажте `BalachkySetup-1.2.4.4-beta-42203EA0.exe` з [офіційної сторінки випуску v1.2.4.4-beta](https://github.com/mykola-zhukovets/balachky/releases/tag/v1.2.4.4-beta) і запустіть інсталятор. Для завантаження моделі потрібен інтернет, якщо Ви не імпортуєте файли з офлайн-пакета.
