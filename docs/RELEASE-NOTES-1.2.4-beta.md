# Примітки до випуску · Release Notes — v1.2.4-beta

**Файл / File:** `BalachkySetup-1.2.4-beta-7307EA13.exe`<br>
**SHA-256:** `7307EA13B0CAE2BCF7EE59417EE8A820F634299303242E99A60BE5F7FAC586F4`<br>
**Розмір / Size:** 161,7 МБ / 161.7 MB (169 593 245 байтів / bytes)<br>
**VirusTotal:** [сторінка файла за SHA-256 / file page by SHA-256](https://www.virustotal.com/gui/file/7307ea13b0cae2bcf7ee59417ee8a820f634299303242e99a60be5f7fac586f4/detection)

---

## Українська версія

Другий бета-випуск програми “Балачки у Коростені” (`v1.2.4-beta`).
...
1. Завантажте інсталятор `BalachkySetup-1.2.4-beta-7307EA13.exe` з розділу Releases.
...
The second beta release of Balachky (`v1.2.4-beta`).
...
1. Download the installer `BalachkySetup-1.2.4-beta-7307EA13.exe` from the Releases page.
