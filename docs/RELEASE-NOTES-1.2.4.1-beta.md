# Примітки до випуску · Release Notes — v1.2.4.1-beta

**Файл / File:** `BalachkySetup-1.2.4.1-beta-3C5F6144.exe`<br>
**SHA-256:** `3C5F61447C22596CFED5B5ACD8C32D88A4B91BE1768B0DEFE340233437186145`<br>
**Розмір / Size:** 161,8 МБ / 161.8 MB (169 611 393 байтів / bytes)<br>
**VirusTotal:** [сторінка файла за SHA-256 / file page by SHA-256](https://www.virustotal.com/gui/file/3c5f61447c22596cfed5b5acd8c32d88a4b91be1768b0defe340233437186145/detection)

---

## Українська версія

Виправлений бета-випуск програми “Балачки у Коростені” (`v1.2.4.1-beta`).

### Що виправлено в 1.2.4.1

Випуск 1.2.4-beta відкликано: у ньому не працювало відтворення відео всередині програми (самі записи були цілі). Тут це виправлено, а разом із ним — п'ять зауважень із живого випробування: майстер першого запуску не давав підтвердити вибір компонентів, пропонував завантажити те, що вже є на комп'ютері, обіцяв крок, якого не буде, а підписи деяких кнопок обрізалися.

### What is fixed in 1.2.4.1

Release 1.2.4-beta was withdrawn: video playback inside the app did not work there (the recordings themselves were intact). This is fixed here, along with five findings from live testing: the first-run wizard would not let you confirm your component choice, offered downloads for components already on the computer, promised a step that never came, and some button labels were clipped.
...
1. Завантажте інсталятор `BalachkySetup-1.2.4.1-beta-3C5F6144.exe` з розділу Releases.
...
The fixed beta release of Balachky (`v1.2.4.1-beta`).
...
1. Download the installer `BalachkySetup-1.2.4.1-beta-3C5F6144.exe` from the Releases page.
