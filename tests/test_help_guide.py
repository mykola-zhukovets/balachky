...
class OpenUserGuideTests(unittest.TestCase):
    ...
    def test_each_language_asks_for_its_own_readme(self):
        ...
        Мапа мов уже двічі розʼїжджалася з файлами при перейменуваннях README,
        і щоразу наслідок був один: «en» відкривало людині українську довідку,
        а «uk» просило файл, якого в репозиторії немає. Старий тест цього не
        бачив, бо перевіряв лише «локальний важливіший за мережу». Тут
        вимагаємо і правильне ім'я, і наявність файлу в репозиторії."""
        from pathlib import Path
        repo = Path(__file__).resolve().parents[1]
        # Канон (рішення власника 01.08, як було від першої публікації):
        # README.md — АНГЛІЙСЬКИЙ, бо це головна сторінка публічного репо;
        # українська — README.uk.md. Коли головну помилково зробили
        # українською, «en» відкривало людині українську довідку.
